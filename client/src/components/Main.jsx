...
export const Main = (props) => {
  return (
    <main className='page-body main-strip mt-5 py-5'>
      <div>
          ...
          <div className='container'>
            <div className='row row-cols-1 row-cols-md-3 row-cols-lg-6 g-3 justify-content-center'>
              <div className='col' data-aos='fade-up' data-aos-duration='800'>
                <Link className='text-decoration-none text-dark' href='#quickstart' to='/create-user'>
                    ...
                    <div className='card-body d-flex flex-column justify-content-center align-items-center text-center'>
                      <div>
                        <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
                          <path fill-rule='evenodd' clip-rule='evenodd' d='M18 8H6V6H18V8Z' fill='#FF4A6E' />
                          <path fill-rule='evenodd' clip-rule='evenodd' d='M18 13H6V11H18V13Z' fill='#FF4A6E' />
                          <path fill-rule='evenodd' clip-rule='evenodd' d='M18 18H6V16H18V18Z' fill='#FF4A6E' />
                        </svg>
                      </div>
